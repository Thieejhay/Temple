...
const SectionContent = () => {
  return (
    <div className='flex flex-col w-screen'>
        <span className='flex justify-center items-center relative h-[15rem] lg:h-[20rem] bg-black'>
        ...
        <div className='flex flex-col lg:py-12 py-6 px-6 lg:px-0 justify-center items-center gap-24 w-screen'>
            <span className='flex flex-col'>
                ...
                <span className='flex flex-col lg:flex-row gap-12'>
                    <span className='flex flex-col gap-2'>
                        ...
                        <Link to='/secondary' ><span className='text-[#061c56] w-fit px-4 flex justify-center py-2 text-sm font-normal rounded-lg bg-[#f6bc75]'>Learn More</span></Link>
                    </span>
