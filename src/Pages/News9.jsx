...
import Open2 from '../assets/open92.png';
import Open3 from '../assets/open91.png';
        ...
        <div className='flex flex-col py-6'>
            ...
            <span className='flex flex-col px-28 py-6 gap-5'>
                <span className='flex flex-col'>
                    <span className='text-2xl font-semibold opacity-90'>Welcome to the Febuary edition of The Flame, Temple School's monthly newsletter! - The Flame.</span>
                    {/* <span className='text-lg opacity-90'>Join Us For Temple's School Open Day!</span> */}
                </span>
                <span className='text-lg opacity-90 font-medium'>This month, Temple School is all about embracing and uplifting one another.Our dedicated teachers and staff members are working tirelessly to continue to create a nurturing environment where every child's unique flame can burn brightly.</span>
                <span className='text-lg font-medium opacity-90'>We would like to appreciate your unwavering support, our fantastic parents, and guardians! Together, we are creating a community where our students flourish and shine.</span>
                <span className='text-lg font-medium opacity-90'>Discover a host of exciting events and articles this February with "The Flame" Get ready for a month filled with passion and fresh perspectives!</span>
                <a href={process.env.PUBLIC_URL + '/files/Feb.pdf'} download>
